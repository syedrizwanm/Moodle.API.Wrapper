...
{
	public sealed class UploadInputModel : IModel 
	{
		...
		public List<KeyValuePair<string,string>> ToKeyValuePairs(string prefix="")
		{
			...
			keyValuePairs.Add(new KeyValuePair<string,string>(ModelHelper.GetPrefixedName("filecontent",prefix),filecontent));
