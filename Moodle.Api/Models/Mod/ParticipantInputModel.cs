...
{
	public sealed class ParticipantInputModel : IModel 
	{
		public int assignid {get;set;}
		public int embeduser {get;set;}
		...
		public List<KeyValuePair<string,string>> ToKeyValuePairs(string prefix="")
		{
			...
			keyValuePairs.Add(new KeyValuePair<string,string>(ModelHelper.GetPrefixedName("embeduser",prefix),embeduser.ToString()));
