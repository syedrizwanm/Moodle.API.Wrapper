...
{
	public sealed class Url : IModel 
	{
		...
		public List<KeyValuePair<string,string>> ToKeyValuePairs(string prefix="")
		{
			...
			keyValuePairs.Add(new KeyValuePair<string,string>(ModelHelper.GetPrefixedName("externalurl",prefix),externalurl));
			...
			keyValuePairs.Add(new KeyValuePair<string,string>(ModelHelper.GetPrefixedName("parameters",prefix),parameters));
