...
{
	public sealed class Folder : IModel 
	{
		...
		public List<KeyValuePair<string,string>> ToKeyValuePairs(string prefix="")
		{
			...
			keyValuePairs.Add(new KeyValuePair<string,string>(ModelHelper.GetPrefixedName("showdownloadfolder",prefix),showdownloadfolder.ToString()));
			keyValuePairs.Add(new KeyValuePair<string,string>(ModelHelper.GetPrefixedName("showexpanded",prefix),showexpanded.ToString()));
