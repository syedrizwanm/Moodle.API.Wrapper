...
{
	public sealed class Survey : IModel 
	{
		...
		public List<KeyValuePair<string,string>> ToKeyValuePairs(string prefix="")
		{
			...
			keyValuePairs.Add(new KeyValuePair<string,string>(ModelHelper.GetPrefixedName("days",prefix),days.ToString()));
			...
			keyValuePairs.Add(new KeyValuePair<string,string>(ModelHelper.GetPrefixedName("questions",prefix),questions));
			keyValuePairs.Add(new KeyValuePair<string,string>(ModelHelper.GetPrefixedName("section",prefix),section.ToString()));
			keyValuePairs.Add(new KeyValuePair<string,string>(ModelHelper.GetPrefixedName("surveydone",prefix),surveydone.ToString()));
