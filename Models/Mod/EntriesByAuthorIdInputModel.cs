...
{
	public sealed class EntriesByAuthorIdInputModel : IModel 
	{
		...
		public List<KeyValuePair<string,string>> ToKeyValuePairs(string prefix="")
		{
			...
			keyValuePairs.Add(new KeyValuePair<string,string>(ModelHelper.GetPrefixedName("authorid",prefix),authorid.ToString()));
